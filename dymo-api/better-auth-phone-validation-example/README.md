<div align="center">
  <h1>Dymo API for Phone Validation in Better-Auth</h1>
  <h3>Validate phones in a single line of code using simple and quick rules.</h3>
...
When initializing a project with the Better-Auth authentication system, it is very important to use a fraud detection and protection system. To this end, at Dymo, we have developed an SDK specifically for users of Better-Auth. However, you can also use the NodeJS SDK with more code without any problems.

# Dymo API for Phone Validation
